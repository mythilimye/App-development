  ...
  return (
    <div className="bg-gray-100 min-h-screen p-4">
      <div className="max-w-3xl mx-auto bg-white p-6 shadow-md rounded-lg">
        ...
        <h5 className="text-xl font-bold mt-4 mb-2">Eligibility</h5>
       <li className="mb-2">
       ...
       any applicable law for the time being in force relating to the processing of Data, including the Information Technology Act, 2000 and Information Technology (Reasonable Security Practices and Procedures and Sensitive Personal Information) Rules, 2011, as amended or replaced from time to time.
        ...
        <h5 className="text-xl font-bold mt-4 mb-2">Pricing</h5>
       <li className="mb-2">
       ...
       <h5 className="text-xl font-bold mt-4 mb-2">Return & Refunds</h5>
       <li className="mb-5">
       We have a "no questions asked return and refund policy" which entitles all our members to return the product at the time of delivery if due to some reason they are not satisfied with the quality or freshness of the product. We will take the returned product back with us and issue a credit note for the value of the return products which will be credited to your account on the Site. This can be used to pay your subsequent shopping bills.
        ...
        <h4 className="text-xl font-semibold mt-6 mb-4">Governing Law and Jurisdiction</h4>
        <p className="mb-4">
